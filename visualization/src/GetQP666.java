...
/**
 * Servlet implementation class GetQP666
 * 
 * Ver el método doGet
 */
@WebServlet("/GetQP666")
public class GetQP666 extends HttpServlet {
	private static final long serialVersionUID = 1L;
    private DBInterfaceQP dbInterface; // dbInterface es para conectarse a la base de datos
    /**
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		dbInterface = new DBInterfaceQP(cm.dbString, cm.dbUser, cm.dbPass);
		dbInterface.openConnection(); // abrir la conexión
		
		// llamada a la función GetQP666 que hace la consulta a la base de datos
		ArrayList<String[]> data = dbInterface.GetQP666(); 
